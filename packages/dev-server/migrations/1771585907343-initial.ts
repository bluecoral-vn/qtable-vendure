...
export class Initial1771585907343 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "product_translation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "languageCode" character varying NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text NOT NULL, "id" SERIAL NOT NULL, "baseId" integer, "customFields__fix_relational_custom_fields__" boolean, CONSTRAINT "PK_62d00fbc92e7a495701d6fee9d5" PRIMARY KEY ("id")); COMMENT ON COLUMN "product_translation"."customFields__fix_relational_custom_fields__" IS 'A work-around needed when only relational custom fields are defined on an entity'`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "enabled" boolean NOT NULL DEFAULT true, "id" SERIAL NOT NULL, "featuredAssetId" integer, "customFields__fix_relational_custom_fields__" boolean, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id")); COMMENT ON COLUMN "product"."customFields__fix_relational_custom_fields__" IS 'A work-around needed when only relational custom fields are defined on an entity'`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product_review_translation" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "languageCode" character varying NOT NULL, "text" character varying NOT NULL, "id" SERIAL NOT NULL, "baseId" integer, CONSTRAINT "PK_36a4cb00acc4f5edcd17f88eedd" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_1955bdfef1451700a3b8be1c16" ON "product_review_translation" ("baseId") `, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "tenant_domain" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "domain" character varying NOT NULL, "isPrimary" boolean NOT NULL DEFAULT false, "sslStatus" character varying NOT NULL DEFAULT 'pending', "verifiedAt" TIMESTAMP, "id" SERIAL NOT NULL, "tenantId" integer NOT NULL, CONSTRAINT "PK_d846ad4a0e476beca719ed8aa33" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_1f840020b111236936baf03d6d" ON "tenant_domain" ("domain") `, undefined);
        await queryRunner.query(`CREATE TYPE "public"."tenant_status_enum" AS ENUM('REQUESTED', 'PROVISIONING', 'TRIAL', 'ACTIVE', 'SUSPENDED', 'PENDING_DELETION', 'DELETED')`, undefined);
        await queryRunner.query(`CREATE TABLE "tenant" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "slug" character varying NOT NULL, "status" "public"."tenant_status_enum" NOT NULL DEFAULT 'REQUESTED', "plan" character varying NOT NULL DEFAULT 'trial', "config" jsonb NOT NULL DEFAULT '{}', "suspendedAt" TIMESTAMP, "deletedAt" TIMESTAMP, "id" SERIAL NOT NULL, "channelId" integer NOT NULL, CONSTRAINT "REL_07bb5a50783fe474138a7f0431" UNIQUE ("channelId"), CONSTRAINT "PK_da8c6efd67bb301e810e56ac139" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_abfd243f7bd832e806d19c5a91" ON "tenant" ("slug") `, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product_custom_fields_reviews_product_review" ("productId" integer NOT NULL, "productReviewId" integer NOT NULL, CONSTRAINT "PK_359a09e593a6989f2543ce3127a" PRIMARY KEY ("productId", "productReviewId"))`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_53c831778126a88788ceb6cf26" ON "product_custom_fields_reviews_product_review" ("productId") `, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_e88c42d22baa3e492e3dcbefe1" ON "product_custom_fields_reviews_product_review" ("productReviewId") `, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "product_review_translation" ADD CONSTRAINT "FK_1955bdfef1451700a3b8be1c166" FOREIGN KEY ("baseId") REFERENCES "product_review"("id") ON DELETE CASCADE ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "tenant_domain" ADD CONSTRAINT "FK_0330429e16c47df54f110792600" FOREIGN KEY ("tenantId") REFERENCES "tenant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "tenant" ADD CONSTRAINT "FK_07bb5a50783fe474138a7f0431d" FOREIGN KEY ("channelId") REFERENCES "channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "product_custom_fields_reviews_product_review" ADD CONSTRAINT "FK_53c831778126a88788ceb6cf264" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`, undefined);
        await queryRunner.query(`ALTER TABLE "product_custom_fields_reviews_product_review" ADD CONSTRAINT "FK_e88c42d22baa3e492e3dcbefe14" FOREIGN KEY ("productReviewId") REFERENCES "product_review"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "product_custom_fields_reviews_product_review" DROP CONSTRAINT "FK_e88c42d22baa3e492e3dcbefe14"`, undefined);
        await queryRunner.query(`ALTER TABLE "product_custom_fields_reviews_product_review" DROP CONSTRAINT "FK_53c831778126a88788ceb6cf264"`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "tenant" DROP CONSTRAINT "FK_07bb5a50783fe474138a7f0431d"`, undefined);
        await queryRunner.query(`ALTER TABLE "tenant_domain" DROP CONSTRAINT "FK_0330429e16c47df54f110792600"`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "product_review_translation" DROP CONSTRAINT "FK_1955bdfef1451700a3b8be1c166"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_e88c42d22baa3e492e3dcbefe1"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_53c831778126a88788ceb6cf26"`, undefined);
        await queryRunner.query(`DROP TABLE "product_custom_fields_reviews_product_review"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_abfd243f7bd832e806d19c5a91"`, undefined);
        await queryRunner.query(`DROP TABLE "tenant"`, undefined);
        await queryRunner.query(`DROP TYPE "public"."tenant_status_enum"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_1f840020b111236936baf03d6d"`, undefined);
        await queryRunner.query(`DROP TABLE "tenant_domain"`, undefined);
        await queryRunner.query(`DROP TABLE "product_review"`, undefined);
        await queryRunner.query(`DROP INDEX "public"."IDX_1955bdfef1451700a3b8be1c16"`, undefined);
        await queryRunner.query(`DROP TABLE "product_review_translation"`, undefined);
